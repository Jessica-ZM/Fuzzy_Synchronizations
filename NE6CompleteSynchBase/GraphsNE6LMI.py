...
data = np.loadtxt('chaosNE6LMI_new.txt')
...
ax.view_init(75,290)
plt.savefig('PhaseSpaceNE6LMIv2.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()
...
plt.ylim(ymin,ymax)
plt.grid(True)
plt.xticks([3000, 6000, 9000, 12000, 15000, 18000],['3000', '6000', '9000', '12,000', '15,000', '18,000'], rotation=45)
plt.savefig('ControlNE6LMI.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()
...
# #plt.ylim(ymin,ymax)
# plt.grid(True)
# # plt.savefig('RelErrorNE6LMI.png')
# plt.show()
...
axins = ax.inset_axes([0.2, 0.55, 0.45, 0.35])
...
plt.savefig('EzoomNE6LMI.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()