...
data = np.loadtxt('chaosSprottALMI.txt')
...
plt.ylim(ymin,ymax)
plt.xticks([5000, 10000, 15000, 20000, 25000, 30000],['5000', '10,000', '15,000', '20,000', '25,000', '30,000'], rotation=45)
plt.grid(True)
plt.savefig('ControlSprottALMI.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()
...
ax.set_xticklabels(['5000', '10,000', '15,000', '20,000', '25,000', '30,000'], rotation=45)
plt.ylabel('Error')
plt.grid(True)
...
plt.savefig('EzoomSprottALMI.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()
