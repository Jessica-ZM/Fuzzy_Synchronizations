...
open (unit = unidadEsc, file = 'chaosLE4LMI_CNO.txt', status = 'UNKNOWN')
...
do i = 1, noIteraciones
   call GautshiOrden2(LE4System, nuecdf, bandera, beta0, beta1, y1, dy1, sy, sdy, t, w, y, h, dy, u, mv, vp, fm1,fm2)
