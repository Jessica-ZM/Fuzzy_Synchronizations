...
data1 = np.loadtxt('chaosChua88_TP_SNNN.txt')
data2 = np.loadtxt('chaosChua89_TP_SNNN.txt')
data3 = np.loadtxt('chaosChua99_TP_SNNN.txt')
data4 = np.loadtxt('chaosChua100_TP_SNNN.txt')
# data1 = np.loadtxt('chaosChua88_TP_CNO.txt')
# data2 = np.loadtxt('chaosChua89_TP_CNO.txt')
# data3 = np.loadtxt('chaosChua99_TP_CNO.txt')
# data4 = np.loadtxt('chaosChua100_TP_CNO.txt')
...
plot=plt.figure()
plt.plot(itera,a*x11,'g-',label=r'$x_1$')
plt.plot(itera,y11,'m--',label=r'$y_1$')
...
ls = len(x11)-1
plt.xlim(0, ls)
ymin = min(min(x11),min(y11))
ymax = max(max(x11),max(y11))
plt.ylim(ymin,ymax)
plt.grid(True)
plt.show()

plot=plt.figure()
plt.plot(itera,a*x12,'g-',label=r'$x_2$')
plt.plot(itera,y12,'m--',label=r'$y_2$')
plt.title('Iterations series')
plt.ylabel('State variables')
plt.xlabel('Iterations')
plt.legend(loc='best')
plt.xlim(0, ls)
ymin = min(min(x12),min(y12))
ymax = max(max(x12),max(y12))
plt.ylim(ymin,ymax)
plt.grid(True)
plt.show()

plot=plt.figure()
plt.plot(itera,a*x13,'g-',label=r'$x_3$')
plt.plot(itera,y13,'m--',label=r'$y_3$')
plt.title('Iterations series')
plt.ylabel('State variables')
plt.xlabel('Iterations')
plt.legend(loc='best')
plt.xlim(0, ls)
ymin = min(min(x13),min(y13))
ymax = max(max(x13),max(y13))
plt.ylim(ymin,ymax)
plt.grid(True)
plt.show()
...
# # Save figure with nice margin
plt.savefig('E1zoomChuaPDCv2.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
# plt.show()
...
# # Save figure with nice margin
plt.savefig('E2zoomChuaPDCv2.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
# plt.show()
...
# # Save figure with nice margin
plt.savefig('E3zoomChuaPDCv2.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
# plt.show()
