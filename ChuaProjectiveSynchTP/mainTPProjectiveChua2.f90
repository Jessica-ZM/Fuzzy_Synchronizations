...
integer(kind = 4) :: i, j, k, m, puntos, n, noIteraciones
...
open (unit = unidadEsc, file = 'chaosChua99_TP_CNO.txt', status = 'UNKNOWN')
...
do i = 1, noIteraciones
   call GautshiOrden2(ChuaSystem, nuecdf, bandera, beta0, beta1, y1, dy1, sy, sdy, t, w, y, h, dy, u, mv, vp, f1,f2)
