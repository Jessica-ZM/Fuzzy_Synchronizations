...
# data1 = np.loadtxt('chaosLE488_TP_CNO.txt')
# data2 = np.loadtxt('chaosLE489_TP_CNO.txt')
# data3 = np.loadtxt('chaosLE499_TP_CNO.txt')
# data4 = np.loadtxt('chaosLE4100_TP_CNO.txt')

data1 = np.loadtxt('chaosLE488_TP_SNNN.txt')
data2 = np.loadtxt('chaosLE489_TP_SNNN.txt')
data3 = np.loadtxt('chaosLE499_TP_SNNN.txt')
data4 = np.loadtxt('chaosLE4100_TP_SNNN.txt')
...
ax.plot3D(x11,x12,x13,'g-', label=r'master')
ax.plot3D(y11,y12,y13,'m--', label=r'slave')
plt.legend(loc='best')
...
# plt.savefig('PhaseSpaceChuaLMIv2.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()
...
# plt.plot(itera,e33,'m:',label=r'$e_3(t)$')
# plt.ylabel('Error')
...
# plot=plt.figure()
# plt.xscale('log')
# plt.plot(itera,e11,'m-',label=r'$\gamma = 0.70$')
# plt.plot(itera,e21,'pink',label=r'$\gamma = 0.71$')
...
# plot=plt.figure()
# plt.xscale('log')
# plt.plot(itera,e12,'m-',label=r'$\gamma = 0.70$')
# plt.plot(itera,e22,'pink',label=r'$\gamma = 0.71$')
...
# plt.ylim(ymin,ymax)
# plt.grid(True)
# plt.savefig('Error2LE4PDC.png')
# plt.show()

# #Error 3 log
# plot=plt.figure()
# plt.xscale('log')
# plt.plot(itera,e13,'m-',label=r'$\gamma = 0.70$')
# plt.plot(itera,e23,'pink',label=r'$\gamma = 0.71$')
...
# una forma de evitar la division entre cero
er3 = np.zeros_like(e12)

for i in range(0,19200):
    if x33[i] == 0:
        er3[i] = 0
    else :
        er3[i] = abs(e33[i])/x33[i]
...
ax.plot(itera,e11,'m',label=r'$\gamma = 0.70$')
ax.plot(itera,e21,'pink',label=r'$\gamma = 0.71$')
...
axins = ax.inset_axes([0.18, 0.55, 0.38, 0.35])
...
x1, x2, y1, y2 = l1, l2, y1min, y2max+0.0003
...
# # Save figure with nice margin
# plt.savefig('E1zoomLE4PDC.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
# plt.show()
...
# inset axes....
# axins = ax.inset_axes([0.5, 0.55, 0.38, 0.35])
axins = ax.inset_axes([0.3, 0.55, 0.38, 0.35])
...
x1, x2, y1, y2 = l1, l2, y1min-0.0003, y2max+0.0003
axins.set_xlim(x1, x2)
axins.set_ylim(y1, y2)
axins.set_xticks([l1, pm, l2])
axins.set_xticklabels([l1, pm, l2])
...
ax.indicate_inset_zoom(axins, edgecolor="black")
# # # Save figure with nice margin
# plt.savefig('E2zoomLE4PDC.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
# # plt.show()
...
# inset axes....
# axins = ax.inset_axes([0.5, 0.55, 0.38, 0.35])
axins = ax.inset_axes([0.25, 0.3, 0.38, 0.35])
...
x1, x2, y1, y2 = l1, l2, y1min-0.0001, y2max+0.0001
axins.set_xlim(x1, x2)
axins.set_ylim(y1, y2)
axins.set_xticks([l1, pm, l2])
axins.set_xticklabels([l1, pm, l2])
...
# # # Save figure with nice margin
# plt.savefig('E3zoomLE4PDC.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
# # plt.show()
