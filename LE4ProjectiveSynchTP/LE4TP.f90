!******************************************
      ...
      subroutine LE4System (nuecdf,T, Y, DY, U, mv, vp, f1, f2)
     ...
     !*****************************************************************
      ...
      double precision :: vp(37), f1(37), f2(37)
      integer(kind = 4) :: mv
...
!Matrices del modelo difuso SNNN
!	  A1(1,1) =  0.0d0
!	  A1(1,2) =  1.0d0
!	  A1(1,3) =  0.0d0
!	  A1(2,1) =  -1.0d0
!	  A1(2,2) =  0.0d0
!	  A1(2,3) =  3.6864947e+00
!	  A1(3,1) =  -1.6957876e+01
!	  A1(3,2) =  0.0d0
!	  A1(3,3) =  -3.6864947e+00
!
!	  A2(1,1) =  0.0d0
!	  A2(1,2) =  1.0d0
!	  A2(1,3) =  0.0d0
!	  A2(2,1) =  -1.0d0
!	  A2(2,2) =  0.0d0
!	  A2(2,3) =  -8.0000000e-01
!	  A2(3,1) =  3.6800000e+00
!	  A2(3,2) =  0.0d0
!	  A2(3,3) =  8.0000000e-01

!Matrices del modelo difuso CNO
	  A1(1,1) =  0.0d0
	  A1(1,2) =  1.0d0
	  A1(1,3) =  0.0d0
	  A1(2,1) =  -1.0d0
	  A1(2,2) =  0.0d0
	  A1(2,3) =  -8.0000000e-01
	  A1(3,1) =  3.6800000e+00
	  A1(3,2) =  0.0d0
	  A1(3,3) =  8.0000000e-01
...
!	  !write(*,"(F7.3)") M2D
      ...
      CALL SPCOEF(mv,vp,f1,BV,CV,DV,FLAG)
      call SVALUE(mv,vp,f1,BV,CV,DV,Y(2),INTERV,M1D,FLAG)
      PRINT *,' T =',Y(2),'  M1D =',M1D,'  FLAG =',FLAG

      CALL SPCOEF(mv,vp,f2,BV,CV,DV,FLAG)
      call SVALUE(mv,vp,f2,BV,CV,DV,Y(2),INTERV,M2D,FLAG)
      PRINT *,' T =',Y(2),'  M2D =',M2D,'  FLAG =',FLAG
!      write(*,*) M1D
!	  write(*,*) M2D
