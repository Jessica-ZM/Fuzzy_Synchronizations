...
!
subroutine GautshiOrden2(dsedo, nuecdf, bandera, beta0, beta1, y1, dy1, sy, sdy, t, w, y, h, dy,u)
...
if (bandera == 1) then
   ...
   call dsedo(nuecdf, t, y, dy,u)

   !Estimanos yn+1 por medio de un RK2: y = yn+1, fn = dy
   call drtrap(dsedo, nuecdf, y1, dy1, t, y, h, dy, u)
   ...
   call dsedo(nuecdf, t, y, dy,u)  !dy = fn+1
