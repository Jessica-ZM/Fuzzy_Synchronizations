...
# plt.xticks()
# Save figure with nice margin
plt.savefig('ControlChuaLMI.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()
...
axins.set_xticklabels(['10,000', '11,500', '13,000'])
...
# Save figure with nice margin
plt.savefig('EzoomChuaLMI.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()
