...
data = np.loadtxt('chaosNE6LMI_SNNN.txt')
# data = np.loadtxt('chaosNE6LMI_CNO.txt')
...
plt.ylim(ymin,ymax)
plt.grid(True)
# plt.savefig('ControlNE6LMIv2.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()
...
# plt.savefig('EzoomNE6LMIv2.png', dpi = 300, bbox_inches = 'tight', pad_inches = .1)
plt.show()