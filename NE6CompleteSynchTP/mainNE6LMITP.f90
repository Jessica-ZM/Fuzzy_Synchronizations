...
program ChaosNE6Hidden

implicit none

external NE6System  ! Sistema caotico dinamico
...
! Contador de llamada a la subroutine NE6
...
real(kind = 8) :: u(3)
real(kind = 8) :: vp(37), fm1(37), fm2(37)
integer(kind = 4) :: mv
...
open (unit = unidadEsc, file = 'chaosNE6LMI_SNNN.txt', status = 'UNKNOWN')
...
mv = 37
do m = 1, mv
    read(unidadLec, 10000) vp(m), fm1(m), fm2(m)
enddo

write(*, 10000) vp(1), fm1(1), fm2(1)
write(*, 10000) vp(20), fm1(20), fm2(20)
write(*, 10000) vp(37), fm1(37), fm2(37)

 ! Ciclo simulacion
do i = 1, noIteraciones
   call GautshiOrden2(NE6System, nuecdf, bandera, beta0, beta1, y1, dy1, sy, sdy, t, w, y, h, dy, u, mv, vp, fm1,fm2)
